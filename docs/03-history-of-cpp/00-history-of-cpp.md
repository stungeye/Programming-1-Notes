...
[The C programming language](<https://en.wikipedia.org/wiki/C_(programming_language)>) was created in the 1970s at the American research organization [Bell Labs](https://en.wikipedia.org/wiki/Bell_Labs). Bell researchers at that time were also developing [the Unix operating system](https://en.wikipedia.org/wiki/Unix). [Dennis Ritchie](https://en.wikipedia.org/wiki/Dennis_Ritchie) developed C at Bell Labs, building on [Ken Thompson](https://en.wikipedia.org/wiki/Ken_Thompson)’s B programming language, while they and their colleagues developed Unix. C remains a major implementation language for operating-systems, including large portions of the Linux, Windows, and macOS kernels.
...
In the late 70s [Bjarne Stroustrup](https://en.wikipedia.org/wiki/Bjarne_Stroustrup) (also at Bell Labs) started work on what would later become [the C++ programming language](https://en.wikipedia.org/wiki/C%2B%2B). Stroustrup's work on the language started by extending C to support the then-new coding paradigm of [object-orientation](https://en.wikipedia.org/wiki/Object-oriented_programming). The language was renamed from "C with Classes" to C++ around 1983-1984 as a nerdy joke: The increment operator in C is the `++` operator, so C++ is "one more than" C, or in other words, an improvement on C.
...
- [The Development of the C Language by Dennis M. Ritchie](https://www.nokia.com/bell-labs/about/dennis-m-ritchie/chist.pdf)
